...
test("temperature diagram with 11-day data", async () => {
  ...
  expect(screen.getByTestId("temperature-diagram")).toHaveTextContent(
    "Temperature"
  );
...
test("dew point diagram with 11-day data", async () => {
  ...
  expect(screen.getByTestId("dew-point-diagram")).toHaveTextContent(
    "Dew point"
  );
...
test("felt temperature diagram with 11-day data", async () => {
  ...
  expect(screen.getByTestId("felt-temperature-diagram")).toHaveTextContent(
    "Felt temperature"
  );
...
test("temperature combined diagram with 11-day data", async () => {
  ...
  expect(screen.getByTestId("temperature-combined-diagram")).toHaveTextContent(
    "Temperature, Felt temperature and Dew point (Ø per day)"
  );
...
test("temperature min max diagram with 11-day data", async () => {
  ...
  expect(screen.getByTestId("temperature-min-max-diagram")).toHaveTextContent(
