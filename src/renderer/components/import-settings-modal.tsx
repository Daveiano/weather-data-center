...
export const ImportSettingsModal: FunctionComponent<
  ImportSettingsModalProps
> = (props: ImportSettingsModalProps): React.ReactElement => {
  const [saved, setSaved] = useState(false);
  const [isSubmitting, setIsSubmitting] = useState(false);
  const form = useRef(null);
  const modal = useRef(null);
  const initialValues: ImportSettingsFormValues = props.config
    ? props.config
    : {
        import_date_format: "",
        header_time: "",
  ...
  useEffect(() => {
    const removeEventListener = window.electron.IpcOn("config-saved", () =>
      configSavedListener()
    );
  ...
  return (
    <div ref={modal}>
      ...
      >
        <div
          className="bx--type-body-short-01"
          style={{ marginBottom: "2rem" }}
        >
          Here you can change the name of the headers for each characteristic.
          For example the software will look for a column in your csv named
          &quot;pressure&quot; to get the pressure values. You can change this
          behaviour if you change the value of &quot;Header Pressure&quot; in
          the form.
          <br />
          <br />
          You can also change the display unit of each characteristic.
          <br />
          <strong>Note:</strong> This is only for displaying, there is no
          conversion done.
        </div>
          ...
          {({
            ...
            <div>
              ...
              >
                ...
                <h3
                  className="bx--type-productive-heading-02"
                  ...
                  <Column sm={6} lg={6} max={6}>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.unit_pressure && errors.unit_pressure
                        )}
                    ...
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.unit_solar && errors.unit_solar
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    ...
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.unit_humidity && errors.unit_humidity
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                  ...
                  <Column sm={6} lg={6} max={6}>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.unit_temperature && errors.unit_temperature
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    ...
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.unit_wind_direction &&
                            errors.unit_wind_direction
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                  ...
                  <Column sm={12} lg={12} max={12}>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_time && errors.header_time
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        helperText={
                          <>
                            Date format of you input date. The default of
                            YYYY/M/D k:mm is equivalent to{" "}
                            {moment().format("YYYY/M/D k:mm")}. For more info
                            read the{" "}
                            <a
                              target="_blank"
                              href="https://daveiano.github.io/weather-data-center/manual.html"
                              rel="noreferrer"
                            >
                              manual
                            </a>
                        ...
                        invalid={Boolean(
                          touched.import_date_format &&
                            errors.import_date_format
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                  ...
                  <Column sm={6} lg={6} max={6}>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_pressure && errors.header_pressure
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_solar && errors.header_solar
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_uvi && errors.header_uvi
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_temperature &&
                            errors.header_temperature
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_felt_temperature &&
                            errors.header_felt_temperature
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_dew_point && errors.header_dew_point
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                  ...
                  <Column sm={6} lg={6} max={6}>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_rain && errors.header_rain
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_humidity && errors.header_humidity
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_wind && errors.header_wind
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_gust && errors.header_gust
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
                    <div style={{ marginBottom: "1rem" }}>
                      <TextInput
                        ...
                        invalid={Boolean(
                          touched.header_wind_direction &&
                            errors.header_wind_direction
                        )}
                        disabled={isSubmitting}
                      />
                    </div>
