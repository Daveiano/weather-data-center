...
export const StatsItemNormal: React.FC<StatsItemNormalProps> = (
  props: StatsItemNormalProps
): React.ReactElement => {
  return (
    <Column
    ...
    >
      <Row>
        ...
        <Column lg={props.item.icon ? 8 : 12} max={props.item.icon ? 9 : 12}>
          ...
          <div className="value bx--type-expressive-heading-03">
            {props.value}
          </div>
